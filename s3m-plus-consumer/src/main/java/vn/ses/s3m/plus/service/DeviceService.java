...
public interface DeviceService {
    ...
    void addDevice(DeviceForm condition);

    List<Device> getDeviceByProjectId(Map<String, String> condition);

    Integer getCountDevice(Integer customerId, Integer superManagerId, Integer managerId, Integer areaId,
        Integer projectId);
    ...
    void updateDeviceTool(Device device);

    void setDeviceEmpty(Integer systemMapId);

    List<Device> getIds(String[] deviceIds, String schema);

    void setDeviceCaculator(String[] deviceIds);

    void removeDeviceCaculator(String[] deviceIds, Integer systemMapId);
