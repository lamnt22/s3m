...
public class SettingController {
    ...
    public ResponseEntity<Setting> getSettingById(@PathVariable final Integer settingId) {
        ...
        String[] settingValue = setting.getSettingValue()
                .split(Constants.ES.COMMA_CHARACTER);
            ...
            if (StringUtils.isNotEmpty(String.valueOf(settingId))) {
                ...
                if (StringUtils.isNotEmpty(setting.getSettingValue2())) {
                    setting.setSettingValue(setting.getSettingValue()
                            .concat(",")
                            .concat(setting.getSettingValue2()));
                }
    ...
    public ResponseEntity<List<Setting>> getSettingByDeviceIds(
    ...
    public ResponseEntity<List<SettingWarning>> getSettingByDeviceType(
    ...
    public ResponseEntity<?> updateSetting(@RequestBody SettingWarning st, @RequestParam("devices") String devices) {
        ...
        if(st.getSettingValue() != null || st.getSettingValue() != "") {
        ...
        for (String device: str) {
            ...
            String settingMessage = "@" + setting.getType() + "*" + setting.getCustomerId() + "*" + setting.getProjectId() + "*" + setting.getSettingId() + "*" + st.getSettingValue();
            callToSetingWarning(settingMessage);
        }
...
//
    ...
    public ResponseEntity<List<Setting>> getSettingHistory (
